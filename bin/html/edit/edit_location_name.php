...
<div class='page'>
	...
	<div id='spalte1F'>
		...
		//echo "Dateiname: ".$FileNameV.", Location-ID: ".$loc_id.", Owner: ".$c_username.", Ort: ".$ort;
		echo "
		...
		<TABLE id='kat'>
			<TR id='kat'>
				...
				IF ($num2 > '0')
				{
					...
					$radius = 5000;
					$diff_lat = 0.000008999280058; //(Winkel�nderung je Meter)
					$delta_lat = $radius * $diff_lat;
					$lat_min = $lat - $delta_lat;
					$lat_max = $lat + $delta_lat;
					//echo "Breite: ".$lat.", min. Breite: ".$lat_min.", max. Breite: ".$lat_max."<BR>";
					
					//geogr. L�nge: hier ist dei Winkel�nderung / Entfernung von der geogr. Breite abh�ngig:
					...
					FOR($i5='0'; $i5<$num5; $i5++)
					{
						...
						ELSEIF($location !== 'Ortsbezeichnung')
						{
							...
							IF($abstand[$position] > $delta)
							{
								...
								//echo "neuer Abstand wurde �bernommen<BR>";
							}
						}
					}
