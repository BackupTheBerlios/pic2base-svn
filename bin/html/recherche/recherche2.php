...
{
	var check = confirm("Wollen SIe das Bild wirklich l�schen?");
	if(check == true)
	{
...
//###############################################################################################################	
	...
	{
		CASE 'zeit':
		$modus='recherche';	//bedeutet, da� keine Checkboxen angezeigt werden und der Hinweistext entsprechend 				angepa�t wird
		$mod='zeit';
		break;
