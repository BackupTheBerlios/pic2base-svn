...
echo "<div class='page'>
	...
	{
		$result4 = mysql($db, "SELECT * FROM $table2 WHERE note ='$note' ORDER BY pic_id");
		...
		FOR($i4='0'; $i4<$num4; $i4++)
		{
			...
			$FNHQ = mysql_result($result4, $i4, 'FileNameHQ');
			...
			IF(($i4 + 1) == $num4)
			{
				echo "<meta http-equiv='Refresh', Content='1; URL=../../html/admin/adminframe.php'>";
			}
		}
	}
	?>
