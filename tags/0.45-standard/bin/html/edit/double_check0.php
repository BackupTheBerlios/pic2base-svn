...
<div class='page'>
	...
	<div class='content'>";
	//Pr�fung auf �bereinstimmende Bildgr��e, Original-Dateinamen, Dateigr��e:
	echo "<CENTER>
		...
		Die folgenden Bilder weisen in Breite, H�he, Original-Dateinamen und Datei-Gr��e �bereinstimmung auf.<BR>
		Wenn Sie ein Bild mit der Maus �berfahren, erhalten Sie eine verg&ouml;�erte Vorschau.<BR>
	...
	FOR($i2='0'; $i2<$num2; $i2++)
	{
		...
		FOR($i3='0'; $i3<$num3; $i3++)
		{
			...
			//echo "Breite: ".$width.", H�he: ".$height."<BR>";
			$result4 = mysql_query( "SELECT * FROM $table2 WHERE Width = '$width' AND Height = '$height'");
			$num4 = mysql_num_rows($result4);
			
			IF($num4 > '1')
			{
				//echo "Es gibt ".$num4." Bilder mit den Ma�en ".$width." x ".$height.", <BR>";
				$summe = $summe + $num4;
				//Wenn es mehr als ein Bild mit den Ma�en gibt, wird auf �bereinstimmung des Original-Dateinamens gepr�ft:
				...
				FOR($i5='0'; $i5<$num5; $i5++)
				{
					//Pr�fung auf �bereinstimmung der Dateigr��e bei den Bildern mit �bereinstimmenden Datei-Namen:
	...
	FOR($i2='0'; $i2<$num2; $i2++)
	{
		...
		FOR($i3='0'; $i3<$num3; $i3++)
		{
			...
			IF($num4 > '1')
			{
				echo "Es gibt ".$num4." Bild(er) mit den Ma�en ".$width." x ".$height."<BR>";
				FOR($i4='0'; $i4<$num4; $i4++)
				{
