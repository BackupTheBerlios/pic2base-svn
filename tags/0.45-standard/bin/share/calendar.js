//ürde mich sehr über einen Backlink auf www.kjm.hu freuen
//
...
var Kalender = {
  ...
  init: function() {
    ...
    Kalender.eH(document.getElementById("monat"),'mousedown',Kalender.verschieben,false);
  ...
  //
  close: function() { document.getElementById("container").style.display = "none"; },
  ...
  anzeige: function(monat, jahr, obj, pdays, tdays, layout) {
    ...
    document.getElementById("monat").innerHTML = "<a style='text-decoration: none; color: white;' href='JavaScript:Kalender.prevMon()'>&#171;</a> &nbsp;"+Kalender.monate[monat-1]+", "+jahr+"&nbsp; <a style='text-decoration: none; color: white;' href='JavaScript:Kalender.nextMon()'>&#187;</a>";
  ...
  move: function(e) {
    ...
    document.getElementById("container").style.left = (x-o.clickAtX) + "px";
    document.getElementById("container").style.top  = (y-o.clickAtY) + "px";
