...
//var_dump($sr);
  header('Location: ../../../index.php');
	...
	switch ($item)
	{
    	...
    	if (hasPermission($c_username, 'editlocationname')) echo "<a class='navi' href='$inst_path/pic2base/bin/html/admin/adminframe.php?item=editlocationname' title='georeferenzierte Ortsnamen bearbeiten'>Ortsnamen</a>";
    	break;
    	...
    	if (hasPermission($c_username, 'adminlogin')) echo "<a class='navi' href='$inst_path/pic2base/bin/html/admin/adminframe.php?item=adminshowusers' title='Benutzer-Verwaltung'>Benutzer</a>";
    	if (hasPermission($c_username, 'adminlogin')) echo "<a class='navi' href='$inst_path/pic2base/bin/html/admin/adminframe.php?item=adminshowgroups' title='Benutzergruppen-Verwaltung'>Gruppen</a>";
    	if (hasPermission($c_username, 'adminlogin')) echo "<a class='navi' href='$inst_path/pic2base/bin/html/admin/adminframe.php'>Zur&uuml;ck</a>";
    	if (hasPermission($c_username, 'editlocationname')) echo "<a class='navi' href='$inst_path/pic2base/bin/html/admin/adminframe.php?item=editlocationname' title='georeferenzierte Ortsnamen bearbeiten'>Ortsnamen</a>";
    	break;
