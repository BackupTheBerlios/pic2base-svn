...
<script type="text/javascript"
	src="../ajax/inc/scriptaculous.js?load=effects,builder"></script>
...
<p class="mittel" align='left'>Bitte geben Sie hier Ihren Benutzernamen
und Ihr Passwort ein:</p>
<table class="schmal" border='0' align='center'>
	<tbody>
		<tr>
			<td class='normal'>Benutzername:</td>
			<td class='normal'><input type="text" class="Feld150" name="username"
				size=12 tabindex="1"></td>
		</tr>
		<tr>
			<td class='normal'>Ihr Passwort:</td>
			<td class='normal'><input type="password" class="Feld150"
				name="passwd" size=12 tabindex="2"></td>
		</tr>
		<tr>
			<td class='normal'><BR>
			</td>
		...
		<tr>
			<td class='normal'><input type="submit" value="Login" tabindex="3"
				style='width: 80px;'></td>
			<td class='normal'><INPUT TYPE=button VALUE="Abbrechen"
				onclick="location.href='../../index.php'" tabindex="4"
				style='width: 80px;'></td>
		</tr>
	</tbody>
</table>
