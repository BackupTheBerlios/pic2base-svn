...
<link rel="stylesheet"
	href="<?php echo $this->_tpl_vars['subdir']; ?>
...
<body>
<div class="banner">
<div class="banner-title"><?php echo $this->_tpl_vars['package']; ?></div>
<div class="banner-menu">
<form>
<table cellpadding="0" cellspacing="0" style="width: 100%">
	<tr>
		<td><?php if (count ( $this->_tpl_vars['ric'] ) >= 1): ?> <?php echo smarty_function_assign(array('var' => 'last_ric_name','value' => ""), $this);?>
		...
		<a
			href="<?php echo $this->_tpl_vars['ric'][$this->_sections['ric']['index']]['file']; ?>
"
			target="right"><?php echo $this->_tpl_vars['ric'][$this->_sections['ric']['index']]['name']; ?>
		</a> <?php echo smarty_function_assign(array('var' => 'last_ric_name','value' => $this->_tpl_vars['ric'][$this->_sections['ric']['index']]['name']), $this);?>

		<?php endfor; endif; ?> <?php endif; ?></td>
		<td style="width: 2em">&nbsp;</td>
		<td style="text-align: right"><?php if (count ( $this->_tpl_vars['packages'] ) > 1): ?>
		<span class="field">Packages</span> <select class="package-selector"
			onchange="window.parent.left_bottom.location=this[selectedIndex].value">
			...
			?>
			<option
				value="<?php echo $this->_tpl_vars['packages'][$this->_sections['p']['index']]['link']; ?>
