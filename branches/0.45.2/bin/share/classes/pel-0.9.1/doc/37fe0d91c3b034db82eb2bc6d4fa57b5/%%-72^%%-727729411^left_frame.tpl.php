...
?>
<div class="package-title"><?php echo $this->_tpl_vars['package']; ?></div>
<div class="package-details">

<dl class="tree">

	<dt class="folder-title">Description</dt>
	<dd><a href='<?php echo $this->_tpl_vars['classtreepage']; ?>
.html'
		target='right'>Class trees</a><br />
	<a href='<?php echo $this->_tpl_vars['elementindex']; ?>
.html'
		target='right'>Index of elements</a><br />
		<?php if ($this->_tpl_vars['hastodos']): ?> <a
		href="<?php echo $this->_tpl_vars['todolink']; ?>
...
<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['tutorials']): ?>
	<dt class="folder-title"><img class="tree-icon"
		src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/tutorial_folder.png"
		alt=" ">Tutorials/Manuals</dt>
	<dd><?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['tutorials']['pkg']): ?>
	<dl class="tree">
		<dt class="folder-title"><img class="tree-icon"
			src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/package_folder.png"
			alt=" ">Package-level</dt>
		<dd><?php if (isset($this->_sections['ext'])) unset($this->_sections['ext']);
	...
	<?php endif; ?> <?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['tutorials']['cls']): ?>
	<dl class="tree">
		<dt class="folder-title"><img class="tree-icon"
			src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/class_folder.png"
			alt=" ">Class-level</dt>
		<dd><?php if (isset($this->_sections['ext'])) unset($this->_sections['ext']);
		$this->_sections['ext']['name'] = 'ext';
	...
	<?php endif; ?> <?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['tutorials']['proc']): ?>
	<dl class="tree">
		<dt class="folder-title"><img class="tree-icon"
			src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/function_folder.png"
			alt=" ">Function-level</dt>
		<dd><?php if (isset($this->_sections['ext'])) unset($this->_sections['ext']);
		$this->_sections['ext']['name'] = 'ext';
...
media/images/class_folder.png"
	...
	<dd><img class="tree-icon"
		src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/Interface.png"
		alt="Interface"><a
		href='<?php echo $this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['link']; ?>
'
...
media/images/class_folder.png"
	...
	<dd><img class="tree-icon"
		src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png"
		alt="Class"><a
		href='<?php echo $this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['link']; ?>
'
		target='right'><?php echo $this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['title']; ?>
...
media/images/Function.png"
		alt="Function"><a
		href='<?php echo $this->_tpl_vars['info'][$this->_sections['p']['index']]['functions'][$this->_sections['f']['index']]['link']; ?>
'
...
media/images/folder.png"
	...
	<dd><img class="tree-icon"
		src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/Page.png"
		alt="File"><a
		href='<?php echo $this->_tpl_vars['info'][$this->_sections['p']['index']]['files'][$this->_sections['nonclass']['index']]['link']; ?>
'
...
media/images/function_folder.png"
	...
	<dt class="sub-package"><img class="tree-icon"
		src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/package.png"
		alt="Sub-package"><?php echo $this->_tpl_vars['info'][$this->_sections['p']['index']]['subpackage']; ?>
	</dt>
	<dd>
	<dl class="tree">
	<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['subpackagetutorial']): ?>
		<div><img class="tree-icon"
			src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/tutorial.png"
			alt="Tutorial"><a
			href="<?php echo $this->_tpl_vars['info']['0']['subpackagetutorialnoa']; ?>
"
...
<p class="notes"><a
	href="<?php echo $this->_tpl_vars['phpdocwebsite']; ?>
"
