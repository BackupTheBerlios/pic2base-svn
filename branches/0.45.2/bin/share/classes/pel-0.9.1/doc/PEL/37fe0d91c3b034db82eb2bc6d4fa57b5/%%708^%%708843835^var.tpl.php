...
<a
	name="var<?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
"
...
<span class="var-title"> static <span class="var-type"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_type']; ?>
</span> <span class="var-name"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
</span> <?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_default']): ?>
= <span class="var-default"><?php echo ((is_array($_tmp=$this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_default'])) ? $this->_run_mod_handler('replace', true, $_tmp, "\n", "<br />") : smarty_modifier_replace($_tmp, "\n", "<br />")); ?>
</span><?php endif; ?> (line <span class="line-number"><?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink']):  echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink'];  else:  echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['line_number'];  endif; ?></span>)
</span></div>
...
<?php endif; ?> <?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['descvar']): ?>
<hr class="separator" />
...
?>
	<li><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['descvar'][$this->_sections['vm']['index']]['link']; ?>
...
<div class="var-header"><img
	src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/<?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['access'] == 'private'): ?>PrivateVariable<?php else: ?>Variable<?php endif; ?>.png" />
<span class="var-title"> <span class="var-type"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_type']; ?>
</span> <span class="var-name"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
</span> <?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_default']): ?>
= <span class="var-default"><?php echo ((is_array($_tmp=$this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_default'])) ? $this->_run_mod_handler('replace', true, $_tmp, "\n", "<br />") : smarty_modifier_replace($_tmp, "\n", "<br />")); ?>
</span><?php endif; ?> (line <span class="line-number"><?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink']):  echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink'];  else:  echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['line_number'];  endif; ?></span>)
