...
?>
<a
	name="const<?php echo $this->_tpl_vars['consts'][$this->_sections['consts']['index']]['const_name']; ?>
"
...
<span class="const-title"> <span class="const-name"><?php echo $this->_tpl_vars['consts'][$this->_sections['consts']['index']]['const_name']; ?>
</span> = <span class="const-default"><?php echo ((is_array($_tmp=$this->_tpl_vars['consts'][$this->_sections['consts']['index']]['const_value'])) ? $this->_run_mod_handler('replace', true, $_tmp, "\n", "<br />") : smarty_modifier_replace($_tmp, "\n", "<br />")); ?>
</span> (line <span class="line-number"><?php if ($this->_tpl_vars['consts'][$this->_sections['consts']['index']]['slink']):  echo $this->_tpl_vars['consts'][$this->_sections['consts']['index']]['slink'];  else:  echo $this->_tpl_vars['consts'][$this->_sections['consts']['index']]['line_number'];  endif; ?></span>)
</span></div>
