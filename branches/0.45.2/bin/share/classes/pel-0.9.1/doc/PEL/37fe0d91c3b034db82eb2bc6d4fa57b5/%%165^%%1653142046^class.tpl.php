...
<h2 class="class-name"><img
	src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/<?php if ($this->_tpl_vars['abstract']):  if ($this->_tpl_vars['access'] == 'private'): ?>AbstractPrivate<?php else: ?>Abstract<?php endif;  else:  if ($this->_tpl_vars['access'] == 'private'): ?>Private<?php endif;  endif;  if ($this->_tpl_vars['is_interface']): ?>Interface<?php else: ?>Class<?php endif; ?>_logo.png"
	...
	style="vertical-align: middle"><?php if ($this->_tpl_vars['is_interface']): ?>Interface<?php endif; ?>
<?php echo $this->_tpl_vars['class_name']; ?></h2>

<a name="sec-description"></a>
<div class="info-box">
<div class="info-box-title">Description</div>
<div class="nav-bar"><?php if ($this->_tpl_vars['children'] || $this->_tpl_vars['vars'] || $this->_tpl_vars['ivars'] || $this->_tpl_vars['methods'] || $this->_tpl_vars['imethods'] || $this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>
<span class="disabled">Description</span> | <?php endif; ?> <?php if ($this->_tpl_vars['children']): ?>
<a href="#sec-descendents">Descendents</a> <?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars'] || $this->_tpl_vars['methods'] || $this->_tpl_vars['imethods'] || $this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>|<?php endif; ?>
<?php endif; ?> <?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars']): ?>
<?php if ($this->_tpl_vars['vars']): ?> <a href="#sec-var-summary">Vars</a>
(<a href="#sec-vars">details</a>) <?php else: ?> <a href="#sec-vars">Vars</a>
<?php endif; ?> <?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>|<?php endif; ?>
<?php endif; ?> <?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>
<?php if ($this->_tpl_vars['methods']): ?> <a href="#sec-method-summary">Methods</a>
(<a href="#sec-methods">details</a>) <?php else: ?> <a
	href="#sec-methods">Methods</a> <?php endif; ?> <?php endif; ?> <?php if ($this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>
<?php if ($this->_tpl_vars['consts']): ?> <a href="#sec-const-summary">Constants</a>
(<a href="#sec-consts">details</a>) <?php else: ?> <a href="#sec-consts">Constants</a>
<?php endif; ?> <?php endif; ?></div>
<div class="info-box-body"><?php if ($this->_tpl_vars['implements']): ?>
<p class="implements">Implements interfaces:
<ul>
<?php if (count($_from = (array)$this->_tpl_vars['implements'])):
foreach ($_from as $this->_tpl_vars['int']):
?>
	<li><?php echo $this->_tpl_vars['int']; ?></li>
...
<p class="notes">Located in <a class="field"
	href="<?php echo $this->_tpl_vars['page_link']; ?>
"><?php echo $this->_tpl_vars['source_location']; ?> </a> (line <span
	class="field"><?php if ($this->_tpl_vars['class_slink']):  echo $this->_tpl_vars['class_slink'];  else:  echo $this->_tpl_vars['line_number'];  endif; ?></span>)
</p>
...
<?php endif; ?> <pre><?php if (isset($this->_sections['tree'])) unset($this->_sections['tree']);
...
<div class="nav-bar"><a href="#sec-description">Description</a> | <span
	class="disabled">Descendents</span> <?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars'] || $this->_tpl_vars['methods'] || $this->_tpl_vars['imethods'] || $this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>|<?php endif; ?>
<?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars']): ?> <?php if ($this->_tpl_vars['vars']): ?>
<a href="#sec-var-summary">Vars</a> (<a href="#sec-vars">details</a>) <?php else: ?>
<a href="#sec-vars">Vars</a> <?php endif; ?> <?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>|<?php endif; ?>
<?php endif; ?> <?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>
<?php if ($this->_tpl_vars['methods']): ?> <a href="#sec-method-summary">Methods</a>
(<a href="#sec-methods">details</a>) <?php else: ?> <a
	href="#sec-methods">Methods</a> <?php endif; ?> <?php endif; ?> <?php if ($this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>
...
<table cellpadding="2" cellspacing="0" class="class-table">
	...
	?>
	<tr>
		<td style="padding-right: 2em; white-space: nowrap"><img
			src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/<?php if ($this->_tpl_vars['children'][$this->_sections['kids']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['children'][$this->_sections['kids']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png"
			...
			style="vertical-align: center" /> <?php echo $this->_tpl_vars['children'][$this->_sections['kids']['index']]['link']; ?>

		</td>
		<td><?php if ($this->_tpl_vars['children'][$this->_sections['kids']['index']]['sdesc']): ?>
		<?php echo $this->_tpl_vars['children'][$this->_sections['kids']['index']]['sdesc']; ?>

		<?php else: ?> <?php echo $this->_tpl_vars['children'][$this->_sections['kids']['index']]['desc']; ?>
...
<div class="nav-bar"><a href="#sec-description">Description</a> | <?php if ($this->_tpl_vars['children']): ?>
<a href="#sec-descendents">Descendants</a> | <?php endif; ?> <span
	class="disabled">Constants</span> (<a href="#sec-consts">details</a>) <?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars']): ?>
	<?php if ($this->_tpl_vars['vars']): ?> <a href="#sec-var-summary">Vars</a>
(<a href="#sec-vars">details</a>) <?php else: ?> <a href="#sec-vars">Vars</a>
	<?php endif; ?> | <?php endif; ?> <?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>
| <?php if ($this->_tpl_vars['methods']): ?> <a
	href="#sec-method-summary">Methods</a> (<a href="#sec-methods">details</a>)
	<?php else: ?> <a href="#sec-methods">Methods</a> <?php endif; ?> <?php endif; ?>
</div>
<div class="info-box-body">
<div class="const-summary"><?php if (isset($this->_sections['consts'])) unset($this->_sections['consts']);
...
?>
<div class="const-title"><img
	src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/Constant.png"
	alt=" " /> <a
	href="#<?php echo $this->_tpl_vars['consts'][$this->_sections['consts']['index']]['const_name']; ?>
"
...
<div class="nav-bar"><a href="#sec-description">Description</a> | <?php if ($this->_tpl_vars['children']): ?>
<a href="#sec-descendents">Descendants</a> | <?php endif; ?> <span
	class="disabled">Vars</span> (<a href="#sec-vars">details</a>) <?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>
| <?php if ($this->_tpl_vars['methods']): ?> <a
	href="#sec-method-summary">Methods</a> (<a href="#sec-methods">details</a>)
<?php else: ?> <a href="#sec-methods">Methods</a> <?php endif; ?> <?php endif; ?>
...
<?php endif; ?> <?php endif; ?></div>
<div class="info-box-body">
<div class="var-summary"><?php if (isset($this->_sections['vars'])) unset($this->_sections['vars']);
...
<div class="var-title"><img
	src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/StaticVariable.png"
	alt=" " /> static <span class="var-type"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_type']; ?>
</span> <a
	href="#<?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
"
	title="details" class="var-name"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
</a></div>
<?php endif; ?> <?php endfor; endif; ?> <?php if (isset($this->_sections['vars'])) unset($this->_sections['vars']);
$this->_sections['vars']['name'] = 'vars';
$this->_sections['vars']['loop'] = is_array($_loop=$this->_tpl_vars['vars']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['vars']['show'] = true;
$this->_sections['vars']['max'] = $this->_sections['vars']['loop'];
...
media/images/<?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['access'] == 'private'): ?>PrivateVariable<?php else: ?>Variable<?php endif; ?>.png"
	alt=" " /> <span class="var-type"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_type']; ?>
</span> <a
	href="#<?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
"
	title="details" class="var-name"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
</a></div>
<?php endif; ?> <?php endfor; endif; ?></div>
</div>
</div>
<?php endif; ?>
...
<div class="nav-bar"><a href="#sec-description">Description</a> | <?php if ($this->_tpl_vars['children']): ?>
<a href="#sec-descendents">Descendants</a> | <?php endif; ?> <?php if ($this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>
<?php if ($this->_tpl_vars['consts']): ?> <a href="#sec-const-summary">Constants</a>
(<a href="#sec-consts">details</a>) <?php else: ?> <a href="#sec-consts">Constants</a>
<?php endif; ?> <?php endif; ?> <?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars']): ?>
<?php if ($this->_tpl_vars['vars']): ?> <a href="#sec-var-summary">Vars</a>
(<a href="#sec-vars">details</a>) <?php else: ?> <a href="#sec-vars">Vars</a>
<?php endif; ?> | <?php endif; ?> <span class="disabled">Methods</span>
(<a href="#sec-methods">details</a>)</div>
<div class="info-box-body">
<div class="method-summary"><?php if (isset($this->_sections['methods'])) unset($this->_sections['methods']);
...
<div class="method-definition"><img
	src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/StaticMethod.png"
	alt=" " /> <?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_return']): ?>
static <span class="method-result"><?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_return']; ?>
</span> <?php endif; ?> <a
	href="#<?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_name']; ?>
"
...
</a> <?php if (count ( $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['params'] )): ?>
...
if ($this->_sections['params']['iteration'] != 1): ?>, <?php endif;  if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['params'][$this->_sections['params']['index']]['hasdefault']): ?>[<?php endif; ?><span
	class="var-type"><?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['params'][$this->_sections['params']['index']]['type']; ?>
...
</span><?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['params'][$this->_sections['params']['index']]['hasdefault']): ?>
= <span class="var-default"><?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['params'][$this->_sections['params']['index']]['default']; ?>
</span>]<?php endif;  endfor; endif; ?>) <?php else: ?> () <?php endif; ?>
</div>
<?php endif; ?> <?php endfor; endif; ?> <?php if (isset($this->_sections['methods'])) unset($this->_sections['methods']);
$this->_sections['methods']['name'] = 'methods';
$this->_sections['methods']['loop'] = is_array($_loop=$this->_tpl_vars['methods']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['methods']['show'] = true;
$this->_sections['methods']['max'] = $this->_sections['methods']['loop'];
...
<div class="method-definition"><img
	src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/<?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['constructor']): ?>Constructor<?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['destructor']): ?>Destructor<?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['access'] == 'private'):  if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['abstract']): ?>Abstract<?php endif; ?>PrivateMethod<?php else:  if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['abstract']): ?>Abstract<?php endif; ?>Method<?php endif; ?>.png"
	alt=" " /> <?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_return']): ?>
...
<div class="nav-bar"><a href="#sec-description">Description</a> | <?php if ($this->_tpl_vars['children']): ?>
<a href="#sec-descendents">Descendents</a> | <?php endif; ?> <?php if ($this->_tpl_vars['methods']): ?>
<a href="#sec-var-summary">Vars</a> (<span class="disabled">details</span>)
<?php else: ?> <span class="disabled">Vars</span> <?php endif; ?> <?php if ($this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>
<?php if ($this->_tpl_vars['consts']): ?> <a href="#sec-const-summary">Constants</a>
(<a href="#sec-consts">details</a>) <?php else: ?> <a href="#sec-consts">Constants</a>
<?php endif; ?> <?php endif; ?> <?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>
| <?php if ($this->_tpl_vars['methods']): ?> <a
...
<div class="info-box-body"><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "var.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
?> <?php if ($this->_tpl_vars['ivars']): ?>
<h4>Inherited Variables</h4>
<A NAME='inherited_vars'><!-- --></A> <?php if (isset($this->_sections['ivars'])) unset($this->_sections['ivars']);
...
<blockquote><?php if (isset($this->_sections['ivars2'])) unset($this->_sections['ivars2']);
...
<span class="var-title"> <span class="var-name"><?php echo $this->_tpl_vars['ivars'][$this->_sections['ivars']['index']]['ivars'][$this->_sections['ivars2']['index']]['link']; ?>
</span><?php if ($this->_tpl_vars['ivars'][$this->_sections['ivars']['index']]['ivars'][$this->_sections['ivars2']['index']]['ivar_sdesc']): ?>:
<?php echo $this->_tpl_vars['ivars'][$this->_sections['ivars']['index']]['ivars'][$this->_sections['ivars2']['index']]['ivar_sdesc'];  endif; ?><br>
</span> <?php endfor; endif; ?></blockquote>
<?php endfor; endif; ?> <?php endif; ?></div>
</div>
<?php endif; ?>
...
<div class="nav-bar"><a href="#sec-description">Description</a> | <?php if ($this->_tpl_vars['children']): ?>
<a href="#sec-descendents">Descendents</a> | <?php endif; ?> <?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars']): ?>
<?php if ($this->_tpl_vars['vars']): ?> <a href="#sec-var-summary">Vars</a>
(<a href="#sec-vars">details</a>) <?php else: ?> <a href="#sec-vars">Vars</a>
<?php endif; ?> <?php endif; ?> <?php if ($this->_tpl_vars['methods']): ?>
<a href="#sec-method-summary">Methods</a> (<span class="disabled">details</span>)
<?php else: ?> <span class="disabled">Methods</span> <?php endif; ?></div>
<div class="info-box-body"><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<a name='inherited_methods'><!-- --></a> <?php if (isset($this->_sections['imethods'])) unset($this->_sections['imethods']);
...
<blockquote><?php if (isset($this->_sections['im2'])) unset($this->_sections['im2']);
...
?> <img
	src="<?php echo $this->_tpl_vars['subdir']; ?>
media/images/<?php if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['constructor']): ?>Constructor<?php elseif ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['destructor']): ?>Destructor<?php elseif ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['access'] == 'private'):  if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['abstract']): ?>Abstract<?php endif; ?>PrivateMethod<?php else:  if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['abstract']): ?>Abstract<?php endif; ?>Method<?php endif; ?>.png"
	alt=" " /> <span class="method-name"><?php echo $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['link']; ?>
</span><?php if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['ifunction_sdesc']): ?>:
<?php echo $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['ifunction_sdesc'];  endif; ?><br>
...
<div class="nav-bar"><a href="#sec-description">Description</a> | <?php if ($this->_tpl_vars['children']): ?>
<a href="#sec-descendents">Descendants</a> | <?php endif; ?> <?php if ($this->_tpl_vars['methods']): ?>
<a href="#sec-var-summary">Constants</a> (<span class="disabled">details</span>)
<?php else: ?> <span class="disabled">Constants</span> <?php endif; ?> <?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars']): ?>
<?php if ($this->_tpl_vars['vars']): ?> <a href="#sec-var-summary">Vars</a>
(<a href="#sec-vars">details</a>) <?php else: ?> <a href="#sec-vars">Vars</a>
<?php endif; ?> <?php endif; ?> <?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>
| <?php if ($this->_tpl_vars['methods']): ?> <a
...
<A NAME='inherited_consts'><!-- --></A> <?php if (isset($this->_sections['iconsts'])) unset($this->_sections['iconsts']);
...
<blockquote><?php if (isset($this->_sections['iconsts2'])) unset($this->_sections['iconsts2']);
...
<span class="const-title"> <span class="const-name"><?php echo $this->_tpl_vars['iconsts'][$this->_sections['iconsts']['index']]['iconsts'][$this->_sections['iconsts2']['index']]['link']; ?>
</span><?php if ($this->_tpl_vars['iconsts'][$this->_sections['iconsts']['index']]['iconsts'][$this->_sections['iconsts2']['index']]['iconst_sdesc']): ?>:
<?php echo $this->_tpl_vars['iconsts'][$this->_sections['iconsts']['index']]['iconsts'][$this->_sections['iconsts2']['index']]['iconst_sdesc'];  endif; ?><br>
</span> <?php endfor; endif; ?></blockquote>
<?php endfor; endif; ?> <?php endif; ?></div>
</div>
<?php endif; ?>
