...
<TABLE id="text">
	<TR>
		<TD>Username:</TD>
		<TD><INPUT type="text" maxlength="12" name="username" size="20"></TD>
	</TR>
	<TR>
		<TD>Passwort:</TD>
		<TD><INPUT type="password" maxlength="12" name="passwort1" size="20"></TD>
	</TR>
	<TR>
		<TD>Passwort:</TD>
		<TD><INPUT type="password" maxlength="12" name="passwort2" size="20"></TD>
	</TR>
	<TR>
		<TD>Pfad:</TD>
		<TD><INPUT type="input" name="pfad" size="20"
			value="/opt/lampp/htdocs/"></TD>
	</TR>
	<TR>
		<TD>Aktiv:</TD>
		<TD><SELECT name="aktive" size="1">
...
Das Gleich gilt f�r das Passwort nur mit mindestens 6 Zeichen!<br>
Der Pfad muss existieren und die ben�tigten Rechte haben!<br>
Aktiv/Inaktiv legt fest ob der User sich einloggen darf oder nicht. <br>
<br>
</FORM>
		<?PHP
		break;
...
<TABLE id="text">
	...
	<TR>
		<TD>Rundtrgeladen:</TD>
		<TD><?=$info[4]?> Mb <img src="img/down.gif" alt="Down"></TD>
	</TR>
	<TR>
		<TD>Hochgeladen:</TD>
		<TD><?=$info[5]?> Mb <img src="img/up.gif" alt="UP"></TD>
	</TR>
</TABLE>
<br>
<br>
<SPAN> <a
	href="?action=user&amp;user=status&amp;change_status=<?=$newstatus?>&amp;username=<?=$info[0]?>"><?=$text?></a><BR>
<a href="?action=logs&amp;logs=transfer&amp;userlog=<?=$info[0]?>">Logdateien
einsehen</a><BR>
</SPAN> <?PHP
mysql_close();
break;
