...
<TABLE border="0" cellpadding="5" cellspacing="0" width="100%">
	<TR>
		<TD bgcolor="#FFC125" height="10">
		<CENTER>ProFTPd - Verbindungen
		<div id="user-php"><a href=""
			onClick="NewWindow=window.close('user-online.php')">Informationsfenster
		schliessen</a></div>
