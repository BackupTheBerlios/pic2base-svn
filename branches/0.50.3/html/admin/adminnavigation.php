...
//var_dump($sr);
  header('Location: ../../../index.php');
	...
	switch ($item)
	{
    	...
    	if (hasPermission($c_username, 'editlocationname')) echo "<a class='navi' href='$inst_path/pic2base/bin/html/admin/adminframe.php?item=editlocationname' title='Ortsnamen bearbeiten'>Locations</a>";
    	break;
