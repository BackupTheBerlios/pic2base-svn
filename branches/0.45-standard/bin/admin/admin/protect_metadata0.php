...
if($result1 != false)
{
	//echo "Liste der Felder in exif_data:<BR>";
...
$elements_number = count($ed_fieldname) - 2;	//minus zwei, weil: Felder ed_id und pic_id werden nicht gez�hlt!
...
FOR($r='0'; $r<$rows; $r++)
{
	...
	FOR($cg='0'; $cg<$col_groups; $cg++)
	{
		...
		@$writable = mysql_result($result2, $i2, 'writable');
		IF($writable == '1')
		{
			$checked = 'checked';
		}
